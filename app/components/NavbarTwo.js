...
export default function NavbarTwo() {
    ...
    return (
            <header className="AppHead AppHead-root bg-white w-full text-black flex flex-col box-border shadow-none right-0 left-auto absolute justify-center overflow-hidden">
