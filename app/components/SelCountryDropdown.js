              ...
              <ul className="py-2 text-[#586069] max-h-[40vh] overflow-auto" aria-labelledby="states-button dropdown-list">
                {filteredCountries.map((country) => (
                  <li
                    ...
                    className={`${
                        selectedOption && selectedOption.alpha3Code === country.alpha3Code ? 'selected' : ''} flex outline-0 box-border cursor-pointer items-center justify-start font-medium leading-5 list-none`}
                  ...
                  >
                    <div className="w-full items-center flex cursor-pointer">
                      ...
                      <p className="text-base text-[#444C4C] leading-5 font-medium m-0">{getCurrencyCode(country)}</p>
                    </div>
                  </li>
                ))}
              </ul>
